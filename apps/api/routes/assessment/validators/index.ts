 ...
 */
export function validateAssessmentData(assessmentData: any): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
...
function isValidCycleLength(cycleLength: string): boolean {
