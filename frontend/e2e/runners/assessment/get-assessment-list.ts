...
export async function getAssessmentList(
  ...
  try {
    ...
    const assessmentListContainer = page
      .locator('[data-testid="assessment-list"]')
    ...
    const assessmentItems = page
      .locator('[data-testid="assessment-item"]')
      .or(page.locator('.assessment-item'))
      .or(page.locator('[data-testid*="assessment"]'));
    ...
    if (assessmentCount === 0) {
      const noAssessmentsMessage = page
        .locator('text=No assessments')
      ...
      (await page
        ...
        .or(
          page
            ...
            .or(page.locator('[data-testid="create-assessment"]'))
        )
        .count()) > 0;
