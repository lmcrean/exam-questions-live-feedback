...
async function checkTableColumn(tableName: string, columnName: string): Promise<boolean> {
  try {
...
async function addColumnIfNeeded(tableName: string, columnName: string, columnType: string): Promise<boolean> {
...
async function checkAndUpdateSchema(): Promise<void> {
