...
export async function getAssessmentDetail(page: Page, state: TestState, assessmentId?: string): Promise<AssessmentDetailResult> {
  try {
    ...
    const detailContainer = page.locator('[data-testid="assessment-detail"]').or(
      page.locator('.assessment-detail')
    ).or(
      page.locator('h1:has-text("Assessment")')
    ).or(
      page.locator('h1:has-text("Results")')
    );
    ...
    const resultsContainer = page.locator('[data-testid="assessment-results"]').or(
      page.locator('.assessment-results')
    ).or(
